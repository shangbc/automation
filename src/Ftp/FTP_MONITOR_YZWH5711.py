    ...
    for file in files:
        ...
        if file.startswith('d'):
            ...
            try:
                ...
                logging.error(file)
    writeStr = "10.254.50.249|" + "YZWH5711|" + ftp.pwd() + "|" + str(fileCount) + "|" + timeStrSc + "\n"
...
if __name__ == '__main__':
    ...
    logPathFile = "/app/cbapp/ftp_monitor/log/" + "FTPFILE_NUM_YZWH5711_" + logStr + ".log"
    ...
    fileName = "FTPFILE_NUM_YZWH5711_" + timeStr + ".txt"
    locaName = '/app/cbapp/ftp_monitor/file/' + fileName
    # ftp = ftpconnect("20.26.28.234", 21, "khbz", "khbz!")
    ftp = ftpconnect("10.254.50.249", 1160, "yzwh5711", "!QAZq571")
