    ...
    for file in files:
        ...
        if file.startswith('d'):
            ...
            try:
                ...
                logging.error(file)
    writeStr = "10.254.50.249|" + "FB5710|" + ftp.pwd() + "|" + str(fileCount) + "|" + timeStrSc + "\n"
...
if __name__ == '__main__':
    ...
    logPathFile = "/app/cbapp/ftp_monitor/log/" + "FTPFILE_NUM_FB5710_" + logStr + ".log"
    ...
    fileName = "FTPFILE_NUM_FB5710_" + timeStr + ".txt"
    locaName = '/app/cbapp/ftp_monitor/file/' + fileName
    # ftp = ftpconnect("20.26.28.234", 21, "khbz", "khbz!")
    ftp = ftpconnect("10.254.50.249", 1160, "fb5710", "Ftp5711!")
